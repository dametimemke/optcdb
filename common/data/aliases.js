window.aliases = {
    ...
    409: ['ジンベエ','', 'Jimbe', 'Jimbei', 'Jinbei' ],
    410: ['ジンベエ 王下七武海','', 'Jimbe Warlord of the Sea', 'Jimbei Warlord of the Sea', 'Jinbei Warlord of the Sea' ],
    411: ['バーソロミュー・くま',''],
    ...
    455: ['火炎刀のフォッサ',''],
    456: ['クリエル',''],
    457: ['重火器使いのクリエル','', 'Heavy Specialist Curiel'],
    458: ['センゴク',''],
    459: ['仏のセンゴク',''],
    ...
    784: ['ゲンさん',''],
    785: ['ゲンゾウ ココヤシ村の駐在',''],
    786: ['Dr.ヒルルク','', 'Dr. Hiruruk', 'Dr Hiruruk','Dr. Hiluluk'],
    787: ['Dr.ヒルルク ヤブ医者','', 'Dr. Hiruruk, Quack Doctor', 'Dr Hiruruk, Quack Doctor','Dr. Hiluluk, Quack Doctor'],
    788: ['くいな',''],
    789: ['くいな シモツキ村の少女剣士',''],
    790: ['たまねぎ＆ピーマン＆にんじん','', 'Usopp Pirates','Tamanegi, Piiman & Ninjin'],
    791: ['たまねぎ＆ピーマン＆にんじん ウソップ海賊団','', 'Usopp Pirates','Tamanegi, Piiman & Ninjin, the Usopp Pirates'],
    792: ['アイスバーグ','', 'Iceberg' ],
    ...
    860: ['戦火の勇士コビー 海軍本部曹長','','Coliseum','War Hero Coby'],
    ...
    904: ['ヨコヅナ','','Coliseum'],
    905: ['ロロノア・ゾロ クライガナ島をさすらう剣士','','3D2Y Zoro','Timeskip Zoro','Roronoa Zoro, the Swordsman Who Wanders Kuraigana Island'],
    906: ['ロロノア・ゾロ 世界最強剣士の門弟','','3D2Y Zoro','Timeskip Zoro'],
    907: ['ニコ・ロビン テキーラウルフの収監者','','3D2Y Robin','Timeskip Robin'],
    908: ['ニコ・ロビン 革命の灯火（ともしび）','','3D2Y Robin','Timeskip Robin','Nico Robin, Light of the Revolution'],
    909: ['トニートニー・チョッパー トリノ王国の平和の架け橋','','3D2Y Chopper','Timeskip Chopper',"Tony Tony Chopper, Torino Kingdom's Peace Mediator"],
    910: ['チョッパーマスク 世界の平和を守るヒーロー','','3D2Y Chopper','Timeskip Chopper','Chopper Mask, the Hero Who Protects the World'],
    911: ['サンジ カマバッカ王国の逃走者','','3D2Y Sanji','Timeskip Sanji','Sanji, Kamabakka Queendom Fugitive'],
    912: ['サンジ 男を懸けた愛の料理人','','3D2Y Sanji','Timeskip Sanji','Sanji, the Cook of Love Who Laid His Manliness on the Line'],
    ...
    917: ['マーガレット',''],
    918: ['マーガレット 護国の戦士','','Marguerite, Warrior Defending Her Country'],
    919: ['アフェランドラ',''],
    920: ['スイトピー','','Sweet Pea'],
    ...
    925: ['獄卒長サディちゃん','','Coliseum','Chief Guard Sadie-chan'],
    926: ['獄卒長サディちゃん 獄卒獣の指揮官','','Coliseum','Chief Guard Sadie-chan'],
    ...
    938: ['ナミ 天候の科学の探求者','','Timeskip Nami','3D2Y Nami','Nami, Seeker of Weather Science'],
    939: ['ナミ 空島ウェザリアの泥棒ネコ','','Timeskip Nami','3D2Y Nami'],
    940: ['ウソップ ボーイン列島の大食漢','','Timeskip Usopp','3D2Y Usopp',"Usopp, Boin Archipelago's Glutton"],
    941: ['ウソップ おいはぎの森の果敢な戦士','','Timeskip Usopp','3D2Y Usopp'],
    942: ['フランキー メカアニマルと戦う改造人間','','Timeskip Franky','3D2Y Franky','Franky, Cyborg Fighting Mecha Animals'],
    ...
    1010: ['バトラー伯爵',''],
    1011: ['バトラー伯爵（王なる力）','','Count Butler (Ruling Power)'],
    1012: ['ヘビー総裁',''],
    1013: ['ホットドッグ将軍',''],
    ...
    1026: ['ブルーギリー',''],
    1027: ['ブルーギリー 脚功道格闘家（ジャオクンドー）','','Blue Gilly, Jao Kun Do Martial Artist'],
    ...
    1034: ['バルトロメオ',''],
    1035: ['人食いのバルトロメオ','','Bartolomeo the Cannibal'],
    ...
    1067: [ '熟練女格闘士 九蛇の戦士', '' ],
    1068: [ '敏捷女格闘士 九蛇の戦士', '' ],
    1069: [ 'シュライヤ・バスクード', '', 'Shovel Guy','Shuraiya Bascùd' ],
    1070: [ 'シュライヤ・バスクード 海賊処刑人', '', 'Shovel Guy','Shuraiya Bascùd' ],
    1071: [ 'ガスパーデ', '' ],
    1072: [ 'ガスパーデ ガスパーデ海賊団', '' ],
    1073: [ 'ニードルス', '' ],
    1074: [ 'リッキー', '', 'King Riku'],
    1075: [ 'リッキー 謎の剣闘士', '', 'King Riku','Ricky, Mysterious Gladiator'],
    1076: [ 'レオ', '' ],
    1077: [ 'レオ トンタッタ族戦士長', '','Leo, Captain of the Tontatta Warriors'],
    1078: [ 'マンシェリー', '' ],
    1079: [ 'マンシェリー トンタッタ族王女', '' ],
    1080: [ 'キュロス', '' ],
    1081: [ 'キュロス 元リク王軍軍隊長', '' ],
    1082: [ '首領・サイ', '' ],
    1083: [ '首領・サイ 花ノ国のギャング', '','Don Sai, Flower Country Gang'],
    1084: [ '藤虎', '' ],
    1085: [ 'イッショウ', '', 'Fujitora' ],
    ...
    1098: [ '雷鳥ビリー', '','Billy the Thunder Bird'],
    1099: [ 'コビー 雨の中の曹長', '' ],
    1100: [ 'コビー 露にきらめく曹長', '' ],
    ...
    1109: [ 'ナミ 若返った航海士', '' ],
    1110: [ 'ナミ 酒場のお茶目なアイドル', '','Nami, Playful Bar Idol'],
    1111: [ 'ニコ・ロビン 若返った考古学者', '' ],
    1112: [ 'ニコ・ロビン 酒場の可憐な踊り娘', '','Nico Robin, Pretty Bar Dancer'],
    1113: [ 'チョッパー 若返った船医', '' ],
    1114: [ 'モンキー・D・ルフィ 夢を追い求める冒険者', 'Strong World Luffy','Monkey D. Luffy, Dream-Pursuing Adventurer'],
    1115: [ 'モンキー・D・ルフィ 信念に生きる麦わらの一味', 'Strong World Luffy','Monkey D. Luffy, Loyal Straw Hat Crew'],
    1116: [ 'サンジ 夢を追い求める冒険者', 'Strong World Sanji','Sanji, Dream-Pursuing Adventurer'],
    1117: [ 'サンジ 信念に生きる麦わらの一味', 'Strong World Sanji','Sanji, Loyal Straw Hat Crew'],
    1118: [ 'ナミ 夢を追い求める冒険者', 'Strong World Nami','Nami, Dream-Pursuing Adventurer'],
    1119: [ 'ナミ 信念に生きる麦わらの一味', 'Strong World Nami','Nami, Loyal Straw Hat Crew'],
    1120: [ 'モンキー・D・ルフィ 終わらぬ夢の航跡・麦わらの一味', '', 'Log Luffy' ],
    1121: [ 'モンキー・D・ルフィ 大海賊時代への誓い「海賊王」', '', 'Log Luffy' ],
    1122: [ 'キャベンディッシュ', '','Hakuba','cabbage' ],
    1123: [ '白馬のキャベンディッシュ', '','Hakuba','cabbage','Cavendish of Hakuba'],
    1124: ['スレイマン',''],
    1125: ['首はねスレイマン',''],
    1126: ['オオロンブス',''],
    1127: ['オオロンブス 殺戮支配者',''],
    ...
    1154: ['サルデス 牢番長',''],
    1155: ['軍隊ウルフ',''],
    1156: ['ハンニャバル副署長','','Hannyabal, Vice Warden'],
    1157: ['ハンニャバル副署長 海底監獄インペルダウン','','Hannyabal, Vice Warden of the Underwater Prison Impel Down'],
    1158: ['マゼラン署長',''],
    1159: ['マゼラン署長 海底監獄インペルダウン','','Magellan, Chief Warden of the Underwater Prison Impel Down'],
    1160: ['コアラ ビーチの天使','','Summertime Koala','Swimsuit Koala'],
    1161: ['コアラ 楽園の女神','','Summertime Koala','Swimsuit Koala'],
    1162: ['ギルド・テゾーロ','','Raid','Gild Tesoro'],
    1163: ['ギルド・テゾーロ 黄金船のカジノ王','','Raid','Gild Tesoro, Casino King of Gran Tesoro'],
    1164: ['カリーナ','','Raid'],
    1165: ['カリーナ 黄金船の歌姫','','Raid','Carina, Diva of Gran Tesoro'],
    1166: ['バカラ',''],
    ...
    1170: ['タナカさん',''],
    1171: ['タナカさん 黄金船の警備担当',''],
    1172: ['ブルック 夢を追い求める冒険者','','Strong World Brook','Brook, Dream-Pursuing Adventurer'],
    1173: ['ブルック 信念に生きる麦わらの一味','','Strong World Brook','Brook, Loyal Straw Hat Crew'],
    1174: ['ロロノア・ゾロ 夢を追い求める冒険者','','Strong World Zoro','Roronoa Zoro, Dream-Pursuing Adventurer'],
    1175: ['ロロノア・ゾロ 信念に生きる麦わらの一味','','Strong World Zoro','Roronoa Zoro, Loyal Straw Hat Crew'],
    1176: ['チョッパー 夢を追い求める冒険者','','Strong World Chopper','Chopper, Dream-Pursuing Adventurer'],
    1177: ['チョッパー 信念に生きる麦わらの一味','','Strong World Chopper','Chopper, Loyal Straw Hat Crew'],
    1178: ['オーズ','','Oz'],
    1179: ['魔人オーズ','','Oz'],
    1180: ['虹ヨロイガニ','','Rainbow Armored Crab'],
    1181: ['ブレンハイム',''],
    1182: ['カトラスのブレンハイム',''],
    1183: ['キングデュー',''],
    ...
    1206: ['ラブーン ルンバー海賊団',''],
    1207: ['ニコ・ロビン 夢を追い求める冒険者','','New Strong World Robin','Nico Robin, Dream-Pursuing Adventurer'],
    1208: ['ニコ・ロビン 信念に生きる麦わらの一味','','New Strong World Robin','Nico Robin, Loyal Straw Hat Crew'],
    1209: ['ウソップ 夢を追い求める冒険者','','New Strong World Usopp','Usopp, Dream-Pursuing Adventurer'],
    1210: ['ウソップ 信念に生きる麦わらの一味','','New Strong World Usopp','Usopp, Loyal Straw Hat Crew'],
    1211: ['フランキー 夢を追い求める冒険者','','New Strong World Franky','Franky, Dream-Pursuing Adventurer'],
    1212: ['フランキー 信念に生きる麦わらの一味','','New Strong World Franky','Franky, Loyal Straw Hat Crew'],
