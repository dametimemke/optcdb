window.details = {
    ...
    1864: {//FN Uruoge
        ...
        special: "Recovers 5,000 HP, boosts ATK of Stiker characters by 1.5x, and if during that turn you hit 4 GREAT hits, boosts ATK of Striker characters by 1.75x in the following turn",
        specialName: "Culling the Criminals from this Earthly World",
    },
    1865: {//FN Uruoge
        captain: "Boosts ATK of Striker characters by 1.75x, and protects from defeat as long as HP is above ???%",
        special: "Recovers 5,000 HP, boosts ATK of Stiker characters by 1.5x, and if during that turn you hit 4 GREAT hits, boosts ATK of Striker characters by 1.75x in the following turn",
        specialName: "Culling the Criminals From This Earthly World",
    },
    1866: {//FN Hawkins
        captain: "Boosts ATK of Cerebral characters by 2x",
        special: "Cuts the current HP of each enemy by 10% and at the end of each turn, cuts the current HP of each enemy by 10% and reduces damage taken by 40% for 3 turns",
        specialName: "Fortune-Telling from the Shadow of Death",
    },
    1867: {//FN Hawkins
        captain: "Boosts ATK of Cerebral characters by 2x and boosts crew's chain multiplier by 1.5x",
        special: "Cuts the current HP of each enemy by 10% and at the end of each turn, cuts the current HP of each enemy by 10% and reduces damage taken by 40% for 3 turns",
        specialName: "Fortune-Telling from the Shadow of Death",
    },
    2000: {//Rayleigh
