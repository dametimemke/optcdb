...
/*                            var boost1 = 1.0, boost2 = 1.0, boost3 = 1.0, boost4 = 1.0, boost5 = 1.0;
    ...
    'Strawhat Anni Island Pt 2': {
        description: 'SH boosted.',
        thumb: 1404,
        id: 52,
        atk: function(p) {
            var id = p.number + 1,
                matching = ((id > 1404 && id < 1404) ||
                    [ 217, 420, 520, 548, 571, 578, 659, 727, 761, 795, 937, 1009, 1022, 1115, 1121, 1245, 1285, 1360, 1387, 1463, 1404, 1600, 1682, 219, 218, 421, 554, 580, 766, 906, 1175, 1362, 1372, 1388, 1461, 1676, 1753, 225, 419, 436, 522, 605, 768, 912, 1117, 1368, 1414, 1447, 1452, 1485, 1508, 1514, 1755, 23, 24, 25, 26, 247, 249, 528, 573, 597, 765, 854, 868, 910, 1014, 1113, 1177, 1339, 1370, 1412, 1448, 1465, 1761, 221, 422, 524, 536, 651, 662, 681, 764, 808, 863, 939, 1110, 1119, 1366, 1389, 1709, 1757, 210, 514, 532, 558, 679, 683, 767, 866, 908, 916, 1052, 1112, 1208, 1408, 1549, 1683, 1711, 223, 518, 556, 572, 661, 762, 791, 867, 941, 1210, 1406, 1446, 1543, 1686, 337, 560, 711, 763, 849, 901, 943, 1212, 1364, 1550, 1688 ].indexOf(id) !== -1);
            return !matching ? 1 : 1.75;
        },
        hp: function(p) {
            var id = p.number + 1,
